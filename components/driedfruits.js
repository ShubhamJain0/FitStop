        ...
        return (
            <SafeAreaView style={styles.refreshcontainer}>
                    <View style={{flex: 0.4, justifyContent: 'center'}}>
                        ...
                        <TouchableOpacity style={{alignItems: 'center', margin: hp(4), marginBottom: 75, transform: [{rotate: '-90deg'}]}} onPress={() => navigation.navigate('Dried-Fruits')} >
                        ...
                        <TouchableOpacity style={{alignItems: 'center', margin: hp(4), marginBottom: 75, transform: [{rotate: '-90deg'}], opacity: 0.2}} onPress={() => navigation.navigate('Exotics')} >
