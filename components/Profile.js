...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, Image, SafeAreaView, ActivityIndicator, Platform, Button } from 'react-native';
    ...
    if (respStatus === 401) { 
      return (
        <View style={styles.container}>
          <Image source={require('../assets/undraw_healthy_options_sdo3.png')} style={{width: '100%', height: '50%'}} />
      ...
      return (
        <View style={styles.container}>
          <View style={{marginLeft: wp(10), flexDirection: 'row', alignItems: 'center'}}>
            ...
            <TouchableOpacity style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}} onPress={() => {setModalVisible(true); userData.name ? setChangeName(userData.name): setChangeName(''); userData.email ? setChangeEmail(userData.email): setChangeEmail('')}} activeOpacity={0.5}>
              <AntDesign name="edit" size={wp(4)} color="black" />
              <Text style={{fontFamily: 'sf-semi', fontSize: wp(4), textAlign: 'center', marginLeft: 10}}>Edit Profile</Text>
            </TouchableOpacity>
          </View>
          ...
          <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', marginLeft: wp(10), marginTop: 30}}>
              ...
              <Text style={{fontFamily: 'sf-semi', fontSize: wp(4.5), marginLeft: 25, flex: 1}}>My Ratings</Text>
              <View style={{flex: 1}}>
                <TouchableOpacity style={{alignSelf: 'center', backgroundColor: '#99b898', paddingLeft: wp(2), paddingRight: wp(2), paddingTop: wp(1), paddingBottom: wp(1), borderRadius: 10, elevation: 10, shadowOffset: {width: 0, height: 5}, shadowOpacity: 0.34, shadowRadius: 6.27}} onPress={() => navigation.navigate('Reviews', {action: 'view'})}>
                  <Text style={{fontFamily: 'sf-semi', fontSize: wp(5)}}>&rarr;</Text>
                </TouchableOpacity>
              </View>
            </View>
